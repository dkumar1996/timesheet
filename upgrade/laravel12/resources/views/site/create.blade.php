...
<h3 class="text-center text-info">Site - Add New</h3>
...
@endif
	{{ Form::open(['route' => 'site.store','Method'=>'post','role'=>'form','class'=>'form-horizontal'])}}
		
	<div class="form-group">

	{{Form::label('name','Site Name',['class'=>'col-sm-4 control-label'])}}	
	 <div class="col-sm-8">
	{{Form::text('site_name','',['class'=>'form-control','required'])}}
	</div>
