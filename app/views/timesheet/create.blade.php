...
<h3 class="text-center text-info">Add TimeSheet</h3>
...
{{ Form::open(['route' => 'storeentry','Method'=>'post','role'=>'form','class'=>'form-horizontal'])}}
	...
	<?php $allsites=[''=>'Please select']+DB::table('site')->where('enabled','Yes')->lists('site_name','id');?>

	<div class="form-group">
	{{Form::label('logout_time','Site Name',['class'=>'col-sm-4 control-label'])}}	
	 <div class="col-sm-8">
	{{Form::select('site_id',$allsites,null,['class'=>'form-control text-bold','required','id'=>'site_id'])}}
	</div>
	
	</div>


<?php $allusers=[''=>'Please select']+DB::table('user')->select('id', DB::raw('CONCAT(first_Name, " ", last_Name) AS full_name'))->where('enabled','Yes')->lists('full_name','id');?>

	<div class="form-group">
	{{Form::label('logout_time','Staff Name',['class'=>'col-sm-4 control-label'])}}	
	 <div class="col-sm-8">
	{{Form::select('userid',$allusers,null,['class'=>'form-control text-bold','required','id'=>'user_id'])}}
	</div>
